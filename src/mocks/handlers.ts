...
export const handlers = [
  ...
  rest.get(`${API_PATHS.order}/profile/cart/order`, (req, res, ctx) => {
    return res(ctx.status(200), ctx.delay(), ctx.json<Order[]>(orders));
  }),
  rest.put(`${API_PATHS.order}/profile/cart/order`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
  rest.get(`${API_PATHS.order}/profile/cart/order/:id`, (req, res, ctx) => {
  ...
  rest.delete(`${API_PATHS.order}/profile/cart/order/:id`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
  rest.put(`${API_PATHS.order}/profile/cart/order/:id/status`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
];
